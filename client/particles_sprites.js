...
function init() {
  ...
  for ( i = 0; i < parameters.length; i ++ ) {
    ...
    materials[i] = new THREE.PointCloudMaterial( { size: size, map: sprite, blending: THREE.AdditiveBlending, depthTest: false, transparent: true, opacity: 0.5, color: 0xFF0000 } );
  ...
  renderer = new THREE.WebGLRenderer({ clearAlpha: 1, alpha: true }); // var?
